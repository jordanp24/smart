                        ...
                        <div class="col s12">
                            <div class="card hoverable z-depth-2">
                                <div class="card-title indigo darken-1 white-text">
                                    <h1 class="center-align titulo-3 negrita">VER CLIENTE</h1>
                                </div>
                                        ...
                                        <form method="POST" enctype="multipart/form-data" action="../controller/?op=2">
                                            <div class="row" hidden>
                                                <div class="input-field col s6">
                                                    <input disabled name="idc" id="idc" type="text" class="validate" value="<?php echo $row["id"]; ?>">
                                            ...
                                            <div class="row">
                                                <div class="input-field col s4">
                                                    <input disabled name="dpi" id="dpi" type="text" class="validate" value="<?php echo $row["servicio"]; ?>">
                                                    <label for="dpi" class="black-text">Servicio:</label>
                                                </div>
                                                <div class="input-field col s4">
                                                    <input disabled name="cel" id="cel" type="text" class="validate" value="<?php echo $row["tiposervicio"]; ?>">
                                                    <label for="cel" class="black-text">Tipo servicio:</label>
                                                </div>
                                                <div class="input-field col s4">
                                                    <input disabled name="em" id="em" type="email" class="validate" value="<?php echo $row["morosidad"] == 1 ? 'Moroso' : "Al día"; ?>">
                                            ...
                                            <div class="row">
                                                <div class="input-field center-align">
                                                    ...
                                                    <a onclick="window.history.back()" class="col s12 modal-close waves-effect waves-light btn-small red darken-2 negrita"><i class="material-icons right">cancel</i>Cancelar</a>
                                                </div>
                                            </div>
                                        </form>
                                    <?php
