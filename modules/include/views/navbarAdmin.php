            ...
            <div>
                <div class="nav-wrapper">
                    ...
                    <ul class="right hide-on-med-and-down">
                        ...
                        <li class="waves-effect waves-light"><a class="indigo-text darken-4" href="../../home/views/">Inicio<i class="material-icons left">home</i></a></li>
                        ...
                        <!-- <li class=" "><a class="indigo-text darken-4 dropdown-trigger" href="#" data-target="dropdown1">Operación<i class="material-icons left">add_shopping_cart</i></a></li>
                        ...
                        <!--Segunda-Opcion-de-Web-menu-desplegable-Productos-->
                        <li class=" "><a class="indigo-text darken-4 dropdown-trigger" href="#" data-target="dropdownV">Servicio<i class="material-icons left">network_check</i></a></li>
                        <ul id='dropdownV' class='dropdown-content'>
                            <li><a href="../../ventas/views/ventas.php" class="indigo-text text-darken-2">Ver servicios<i class="material-icons left">visibility</i></a></li>
                            <li><a href="../../ventas/views/ventas-pausadas.php" class="indigo-text text-darken-2">Ver servicios pausados<i class="material-icons left">assignment</i></a></li>
                            <li><a href="../../ventas/views/" class="indigo-text text-darken-2">Agregar servicio<i class="material-icons left">add</i></a></li>
                        ...
                        <li><a class="indigo-text darken-4 dropdown-trigger" href="#!" data-target="dropdown3">Clientes<i class="material-icons left">groups</i></a></li>
                        ...
                        <li><a class="indigo-text darken-4 dropdown-trigger" href="#!" data-target="dropdown4">Usuarios<i class="material-icons left">manage_accounts</i></a></li>
                        <ul id='dropdown4' class='dropdown-content'>
                            ...
                            <li><a href="../../usuarios/views/agregar.php" class="indigo-text text-darken-2">Agregar Usuarios<i class="material-icons left">add</i></a></li>
                        </ul>
                        <!--Fin-Quinta-Opcion-de-Web-menu-desplegable-Usuarios-->


                        <!--Sexta-Opcion-de-Web-menu-desplegable-Perfil-->
                        <li><a class="pink-text darken-4 dropdown-trigger" href="#!" data-target="dropdown5"><?php echo $firstname . ' ' . $lastname; ?><i class="material-icons left">account_circle</i></a></li>
            ...
            <li>
                ...
                <div class="collapsible-body">
                    <ul>
                        ...
                        <li><a href="../../usuarios/views/agregar.php">Agregar Usuarios<i class="material-icons left">add</i></a></li>
                    </ul>
                </div>
            </li>
