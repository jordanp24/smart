                ...
                <div class="nav-wrapper">
                    ...
                    <ul class="right hide-on-med-and-down">
                        ...
                        <ul id='dropdownV' class='dropdown-content'>
                            ...
                            <li><a target="_blank" href="../../ventas/views/rptCierreShort.php" class="indigo-text text-darken-2">Generar Cierre<i class="material-icons left">attach_money</i></a></li>
                        </ul>
                        <!--Fin-Segunda-Opcion-de-Web-menu-desplegable-Productos-->
