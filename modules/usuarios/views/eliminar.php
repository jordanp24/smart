...
<html lang="es">
<?php
$tituloPagina = "Eliminar Usuario |  SMART";
...
<body>
                        ...
                        <div class="col s12">
                            <div class="card hoverable z-depth-2">
                                <div class="card-title indigo darken-1 white-text">
                                    <h1 class="center-align titulo-3 negrita">ELIMINAR USUARIO</h1>
                                </div>
                                <div class="card-content">
                                    ...
                                    ?>
                                        <form class="">
                                            ...
                                            <div class="row">
                                                <div class="input-field col s6">
                                                    <input id="nom" type="text" class="validate" required disabled value="<?php echo $row["nombres"]; ?>">
                                                    <label for="nom" class="black-text">Nombres:<span class="red-text">
                                                            *</span></label>
                                                </div>
                                                <div class="input-field col s6">
                                                    <input id="ape" type="text" class="validate" required disabled value="<?php echo $row["apellidos"]; ?>">
                                            ...
                                            <div class="row">
                                                <div class="input-field col s6">
                                                    <input id="usu" type="text" class="validate" required disabled value="<?php echo $row["usuario"]; ?>">
                                                    <label for="usu" class="black-text">Usuario:<span class="red-text">
                                                            *</span></label>
                                                </div>
                                                <div class="input-field col s6">
                                                    <input id="con" type="password" class="validate" required disabled value="<?php echo $row["contrasena"]; ?>">
                                            ...
                                            <div class="row">
                                                <div class="input-field center-align">
                                                    <button id="enviar" type="button" class="col s6 modal-close waves-effect waves-light btn-small orange darken-1 white-text negrita"><i class="material-icons right">delete</i>Eliminar</button>
    ...
    <script type="text/javascript" src="../js/eliminar.js?v=1.0"></script>
</body>
