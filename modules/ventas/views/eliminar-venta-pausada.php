...
<?php
$tituloPagina = "Eliminar Venta | SMART";
                ...
                <div>
                    ...
                    <div class="row">
                        ...
                        <div class="col s12">
                            ...
                            <div class="row">
                                <div class="input-field center-align">
                                    <button id="enviar" type="button" class="btn-small orange darken-1 negrita"><i class="material-icons right">delete</i>Eliminar</button>
            ...
            $('#enviar').click(function() {
                ...
                if (cantRows > 0) {
                    ...
                    if (confirm("¿Desea guarda los datos?")) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "../controller/?op=eliminarPausada",
                            data: {
