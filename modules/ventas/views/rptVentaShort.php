...
if ($num_results1) {
  ...
  $pdf->Cell(125, 4, utf8_decode('NOMBRE ARTÍCULO'), 1, 0, 'C', 1);
  $pdf->Cell(30, 4, 'CANTIDAD', 1, 0, 'C', 1);
  ...
  a.nombre,
  dv.cantidad,
  dv.preciofinal as precio,
  ((a.precio - a.preciocompra) * dv.cantidad)  AS ganancia
  ...
  if ($num_results2) {
    ...
    while ($row2 = $result2->fetch_assoc()) {
      ...
      $pdf->cell(125, 5, utf8_decode($row2['nombre']), 'L', 0, 'C');
      $pdf->cell(30, 5, round($row2['cantidad'], 2), 'LR', 0, 'C', 0);
