                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="editar-venta-pausada.php?cod=<?php echo $row["id"]; ?>" class="btn white tooltipped" data-position="top" data-tooltip="Editar venta"><i class="material-icons center indigo-text text-darken-3">edit</i></a>
                                        <a href="eliminar-venta-pausada.php?cod=<?php echo $row["id"]; ?>" class="btn white tooltipped" data-position="top" data-tooltip="Eliminar venta"><i class="material-icons center indigo-text text-darken-3">delete</i></a>
                                    </td>
                                </tr>
                            <?php
                                }
